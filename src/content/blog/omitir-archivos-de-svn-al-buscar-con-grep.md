...
Después de agregar eso a tu `.bashrc` sólo corre el comando `source .bashrc` para que tomen efecto (o reinicia tu sesión). También puedes leer las [instrucciones en inglés aquí](https://coreygilmore.com/blog/2007/09/14/ignoring-svn-directories-with-grep/).

Otra opción es mejor usar **[ack](https://petdance.com/ack/)**, funciona en windows y linux por igual... pero eso lo dejaré para otra ocasión.
<!--break-->