...
- [NetBeans](https://netbeans.org/kb/docs/php/debugging.html). El más lento de los 3.
- [PHPStorm](https://www.jetbrains.com/phpstorm/). El más fácil de configurar pero con la interfáz más rara.
- [Eclipse](https://devzone.zend.com/1147/debugging-php-applications-with-xdebug/). El más difícil de configurar, por mucho.
