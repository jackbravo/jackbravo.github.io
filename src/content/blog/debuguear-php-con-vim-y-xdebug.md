...
- [NetBeans](https://netbeans.apache.org/tutorial/main/kb/docs/java/debug-visual/). El más lento de los 3.
- [PHPStorm](https://www.jetbrains.com/phpstorm/). El más fácil de configurar pero con la interfáz más rara.
- [XDebug](https://help.zend.com/zend/current/content/setting_up_debugging.htm). El más difícil de configurar, por mucho.
