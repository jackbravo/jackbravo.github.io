...
GNU/Linux tiene una herramienta que queda como anillo al dedo para este tipo de tareas y se llama [wget](https://www.gnu.org/software/wget/). Sirve para bajar archivos de Internet y soporta HTTP, HTTPS y FTP. Como dice en su [documentación](https://www.gnu.org/software/wget/manual/), sus principales ventajas son:
...
Este archivo lo puedo correr una vez al día, o ponerlo en el [cron](https://es.wikipedia.org/wiki/Cron_(unix)) y me bajara cada vez los archivos nuevos que vaya encontrando. Chido.

Todo esto fue fácil de averiguar gracias al poder de google, este [buen tutorial](https://www.veen.com/jeff/archives/000573.html) escrito en inglés y el man page de wget.