...
Alguna vez tuve una entrada en mi blog `/es/2007/11/09/technorati-blog-claim` que no tenía otro propósito sino el de decirle a <a href="https://technorati.com/">Technorati</a> que este blog es mío. Es decir, asociarlo con mi perfil en technorati</a>.

Technorati es <strong>EL</strong> sitio para buscar <a href="https://es.wikipedia.org/wiki/Blog">blogs</a>. Los autores de blogs se registran en technorati y luego registran a su blog (por medio de <a href="https://es.wikipedia.org/wiki/Rss">rss</a>). Technorati después publica en diferentes <a href="https://en.wikipedia.org/wiki/Technorati">categorías</a> todos (y digo TODOS) los nuevos artículos que se publican en todos (y digo TODOS) los blogs registrados ahí, como se pueden imaginar son muchísimos. Las personas que tienen un blog en technorati pueden votar por los artículos que les parecen más relevantes y de esta manera un blog puede ir ganando autoridad. Los blogs y usuarios con mayor autoridad tienen un voto más fuerte y sus artículos se muestran con mayor visibilidad dentro del sitio de technorati.
...
UPDATE: En realidad toda esa tecnología ya no existe.
